...
class Emitter():
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) is FloatType or in_ is FloatType:
            return self.jvm.emitFALOAD()
        elif type(in_) is BoolType or in_ is BoolType:
    ...
    *   @param name the symbol entry of the variable.
    ...
    def emitWRITEVAR(self, name, inType, index, frame):
        ...
        if type(inType) is IntType or inType is IntType or type(inType) is BoolType or inType is BoolType:
            return self.jvm.emitISTORE(index)
        elif type(inType) is FloatType or inType is FloatType:
